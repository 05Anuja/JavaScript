...
// The above statement is not readable and it was used in Old JS. So to improve the readability there is concept of String Interpolation or String Literals which uses backticks (``) to print a statement with variable value and to display variable values we use '${variable_name}'

// console.log(`My name is ${fullName.toUpperCase()} and I am ${age} years old!`);
...
let newString = fullName.substring(0,3);
// console.log(newString);

// let string3 = fullName.slice(-5,-1);
let string3 = fullName.slice(0,3);
// console.log(string3);
